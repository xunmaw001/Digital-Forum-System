<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品定位" prop="chanpindingwei">
          <el-input v-model="ruleForm.chanpindingwei" 
              placeholder="产品定位" clearable  :readonly="ro.chanpindingwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品定位" prop="chanpindingwei">
              <el-input v-model="ruleForm.chanpindingwei" 
                placeholder="产品定位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="配置详情" prop="peizhixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.peizhixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peizhixiangqing" label="配置详情" prop="peizhixiangqing">
                    <span v-html="ruleForm.peizhixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	fenlei : false,
	pinpai : false,
	chanpindingwei : false,
	shangshishijian : false,
	peizhixiangqing : false,
	clicktime : false,
	clicknum : false,
      },
      ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pinpai = true;
          ...
          if(o=='chanpindingwei'){
            this.ruleForm.chanpindingwei = obj[o];
	    this.ro.chanpindingwei = true;
            continue;
          }
	    ...
	    this.ro.shangshishijian = true;
          ...
          if(o=='peizhixiangqing'){
            this.ruleForm.peizhixiangqing = obj[o];
	    this.ro.peizhixiangqing = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.peizhixiangqing = this.ruleForm.peizhixiangqing.replace(reg,'../../../springboot1f60t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shumabankuai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shumabankuaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
