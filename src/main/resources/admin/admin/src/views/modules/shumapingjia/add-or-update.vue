<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="优点" prop="youdian">
          <el-input v-model="ruleForm.youdian" 
              placeholder="优点" clearable  :readonly="ro.youdian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="优点" prop="youdian">
              <el-input v-model="ruleForm.youdian" 
                placeholder="优点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺点" prop="quedian">
          <el-input v-model="ruleForm.quedian" 
              placeholder="缺点" clearable  :readonly="ro.quedian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺点" prop="quedian">
              <el-input v-model="ruleForm.quedian" 
                placeholder="缺点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="总结" prop="zongjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zongjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zongjie" label="总结" prop="zongjie">
                    <span v-html="ruleForm.zongjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingfen = true;
          ...
          if(o=='youdian'){
            this.ruleForm.youdian = obj[o];
	    this.ro.youdian = true;
            continue;
          }
          if(o=='quedian'){
            this.ruleForm.quedian = obj[o];
	    this.ro.quedian = true;
            continue;
          }
          if(o=='zongjie'){
            this.ruleForm.zongjie = obj[o];
	    this.ro.zongjie = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	...
	this.ruleForm.zongjie = this.ruleForm.zongjie.replace(reg,'../../../springboot1f60t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shumapingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shumapingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
